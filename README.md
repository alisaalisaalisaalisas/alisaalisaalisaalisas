...
* 💬 **Навыки**: Python, C++, GO,  C#, HTML/CSS, базовый JS\TS, SQL, API-тестирование, UI/UX тестирование, Git, Docker, Ubuntu bash 
...
## 🔧 Основные занятия как разработчика:

* Разработка backend-логики на Python (Django, OOP)
* Проектирование структуры приложений и модулей
* Создание REST API, работа с сериализаторами, middleware, авторизацией
* Написание юнит-тестов (pytest, unittest)
* Разработка CLI-утилит и инструментов автоматизации
* Работа с базами данных (PostgreSQL): моделирование таблиц, оптимизация запросов
* Контейнеризация приложений с помощью Docker
* Настройка простых CI/CD-пайплайнов для автоматизации сборки и тестирования
* Разработка веб-интерфейсов (HTML/CSS + базовый JS)
* Работа с Git, ветвлением, pull-request практиками и code review
